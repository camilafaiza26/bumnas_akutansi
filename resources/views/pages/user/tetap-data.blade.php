<x-app-layout>
    <x-slot name="header_content">
        ...
        <div class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></div>
            ...
            {{-- <div class="breadcrumb-item active"><a href="{{ route('datakeuangan') }}">Data Keuangan</a></div> --}}
            <div class="breadcrumb-item active"><a> Data Keuangan</a></div>
            <div class="breadcrumb-item active"><a> Biaya Tetap </a></div>
        </div>
    </x-slot>
    ...
    <div x-data="{ 
        ...
        <div class="bg-white">
            <nav class="flex flex-col sm:flex-row">
                ...
                <button href="#" x-on:click="activeTab = 4" :class="activeTab === 4 ? activeClass : inactiveClass" >
                    <p class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-100">  
                         Biaya Tetap </p>
                </button>
            </nav>
