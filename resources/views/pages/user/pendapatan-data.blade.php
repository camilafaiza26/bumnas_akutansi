<x-app-layout>
    <x-slot name="header_content">
        ...
        <div class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></div>
            ...
            <div class="breadcrumb-item active">Biaya Pendapatan</a></div>
        </div>
    </x-slot>
    ...
    <div x-data="{ 
        ...
        <div class="bg-white">
            <nav class="flex flex-col sm:flex-row">
                <button  href="#" x-on:click="activeTab = 1" :class="activeTab === 1 ? activeClass : inactiveClass"   >
        ...
        <div class="mt-6 bg-white border p-3 ">
            ...
            {{-- <div x-show="activeTab === 2" wire:ignore.self>
                <div id="variable">
